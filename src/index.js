...
function renderDog(dog){
    ...
    let dogRow = `<td data-dog-name=${dog.name} >${dog.name}</td> <td class="breed">${dog.breed}</td> <td>${dog.sex}</td> <td><button class="edit" data-dog-id=${dog.id} data-dog-name=${dog.name} data-dog-breed=${dog.breed} data-dog-sex=${dog.sex} name="submit">Edit Dog</button></td>`
...
function fillForm(button){
    let breed = (button.parentElement.parentElement.querySelector(".breed")).textContent
